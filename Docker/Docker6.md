...
Ejemplo 3: Configuración de imágenes con una aplicación Java
En este ejemplo vamos a estudiar como podemos trabajar con el Servidor de Aplicaciones Apache Tomcat. Para hacer las pruebas vamos a usar la imagen Docker bitnami/tomcat cuya documentación puedes encontrar en Docker Hub.
...
![image](https://github.com/user-attachments/assets/4cb1ba2b-fa74-4cc0-9b22-8b86a5319376)
...
![image](https://github.com/user-attachments/assets/edcb065d-6602-4c8a-b096-924aacbe69f8)
...
![image](https://github.com/user-attachments/assets/bff4fe5b-1f00-4dab-850c-09ba429e1cdf)

$ docker run -d -p 8081:8080 -e TOMCAT_PASSWORD=my-password --name app_java josedom24/app_java:v1

![image](https://github.com/user-attachments/assets/8e489efa-0843-49c6-a500-5a1bc154c737)

Finalmente podemos acceder a la aplicación utilizando un navegador web.

![image](https://github.com/user-attachments/assets/35a4eaca-7b0c-4023-8c42-c71fb3f1e3ff)
